...
instance Semifoldable V4 where
  semifoldMap f (V4 a b c d) = f a <> f b <> f c <> f d
  {-# INLINE semifoldMap #-}

instance Semitraversable V4 where
  semitraverse f (V4 a b c d) = V4 <$> f a <.> f b <.> f c <.> f d
  {-# INLINE semitraverse #-}
