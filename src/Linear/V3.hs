...
instance Semifoldable V3 where
  semifoldMap f (V3 a b c) = f a <> f b <> f c
  {-# INLINE semifoldMap #-}

instance Semitraversable V3 where
  semitraverse f (V3 a b c) = V3 <$> f a <.> f b <.> f c
  {-# INLINE semitraverse #-}
